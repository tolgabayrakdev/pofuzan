              ...
              {recentRecords.map(record => (
                ...
                >
                  ...
                  <div className="text-right">
                    <p
                      className={`text-[10px] font-medium uppercase ${riskColors[record.risk]}`}
                    >
                      {record.risk}
                    </p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-1.5 font-mono text-[10px]">
            ...
            <p className="text-muted-foreground">
              <span className="text-green-500">[12:35:12]</span> Yeni kayıt
              eklendi:{' '}
              <span className="text-foreground">#247 Ahmet Yılmaz</span>
            </p>
            <p className="text-muted-foreground">
              <span className="text-yellow-500">[12:36:01]</span> Dosya
              güncellendi:{' '}
              <span className="text-foreground">#189 Mehmet Demir</span>
            </p>
            <p className="text-muted-foreground">
              <span className="text-destructive">[12:37:23]</span> Yetki
              kontrolü: <span className="text-foreground">LEVEL-1 ACCESS</span>
            </p>
          </div>
        </CardContent>
      </Card>
