        ...
        <CardContent className="space-y-4">
          <div className="p-3 bg-muted/50 rounded-md text-[10px] space-y-2">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Bu sistemde kayıt altına alınan tüm kişi ve işlem verileri,
              yalnızca sistem güvenliği ve denetim amaçlı işlenir. Kişisel
              bilgiler (ad, TC kimlik no, adres, iletişim bilgileri)
              veritabanında şifrelenmiş olarak saklanır ve üçüncü taraflarla
              paylaşılmaz.
            </p>
          </div>
          ...
          <div className="p-3 bg-muted/50 rounded-md text-[10px] space-y-2">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Tüm kullanıcı işlemleri (kayıt ekleme, güncelleme, silme,
              görüntüleme) tarih, saat ve kullanıcı bilgisiyle birlikte
              loglanır. Bu kayıtlar denetim amaçlı tutulur ve silinemez.
            </p>
          </div>
          ...
          <div className="p-3 bg-muted/50 rounded-md text-[10px] space-y-2">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Veriler, endüstri standardı şifreleme protokolleri ile
              korunmaktadır. Yetkisiz erişim attemptleri sistem tarafından
              loglanır ve engellenir.
            </p>
          </div>
